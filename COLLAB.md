...
| # | Prioridad | Tarea | Archivos | Notas |
|---|---|---|---|---|
| ~~CC-10~~ | ~~🔴 CRÍTICO~~ | ~~**ODB port — schema + backend**~~ | ~~✅~~ | ~~2026-06-16~~ |
...
| ~~OC-18~~ | ~~🟡 MEDIO~~ | ~~**VPN tunnels: columna "Connected subnets"** — Campo `connected` (String?) existe en schema VpnTunnel. Se agregó columna con parseo JSON o string directo.~~ | ~~✅~~ | ~~2026-06-16~~ |
