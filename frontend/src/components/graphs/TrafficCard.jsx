...
export default function TrafficCard({ group, oltName }) {
    ...
    <div className="card" style={{ padding: '14px 16px' }}>
      ...
      <ResponsiveContainer width="100%" height={150}>
        <AreaChart data={data} margin={{ top: 4, right: 8, bottom: 0, left: -16 }}>
          ...
          <Area type="monotone" dataKey="rx" name="Rx (Mbps)" stroke="#23a85a" fill="#23a85a" fillOpacity={0.15} strokeWidth={1.5} />
      ...
      <div style={{ display: 'flex', gap: 14, fontSize: 10.5, color: 'var(--text-muted)', marginTop: 4 }}>
        <span>Rx now: <b style={{ color: '#23a85a' }}>{last.rx?.toFixed(1)}</b> · max {maxRx.toFixed(1)} Mbps</span>
