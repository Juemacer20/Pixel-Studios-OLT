...
export const ontAPI = {
  ...
  updateMode:      (id, data) => api.post(`/onts/${id}/update-mode`, data),
  updateMgmtIP:    (id, data) => api.post(`/onts/${id}/update-mgmt-ip`, data),
  ethernetPort:    (id, data) => api.post(`/onts/${id}/ethernet-port`, data),
  wifiPort:        (id, data) => api.post(`/onts/${id}/wifi-port`, data),
  voip:            (id, data) => api.post(`/onts/${id}/voip-service`, data),
  disableVoip:     (id) => api.post(`/onts/${id}/voip-disable`),
  updateIPTV:      (id, data) => api.post(`/onts/${id}/update-iptv`, data),
  gponChannel:     (id, data) => api.post(`/onts/${id}/gpon-channel`, data),
  eponChannel:     (id, data) => api.post(`/onts/${id}/epon-channel`, data),
  reallocateId:    (id, data) => api.post(`/onts/${id}/reallocate-id`, data),
  tr069Profile:    (id, data) => api.post(`/onts/${id}/tr069-profile`, data),
  ...
  tr069Stat:       (id) => api.get(`/onts/${id}/tr069-stat`),
